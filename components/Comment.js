...
function Comment() {
    return (
        <div id="comment" className="py-8 lg:py-16">
            <div className="max-w-2xl mx-auto px-4">
                ...
                <form>
                    ...
                    <button type="submit" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-primary rounded-lg focus:ring-4 focus:ring-primary-500 dark:focus:ring-primary-500 hover:bg-primary-500">
                        Publish post
                    </button>
                </form>
